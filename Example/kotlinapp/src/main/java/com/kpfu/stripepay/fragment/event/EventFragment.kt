...
import com.kpfu.stripepay.databinding.FragmentEventBinding
...
import com.kpfu.stripepay.viewmodel.EventViewModel
...
class EventFragment : Fragment(), BluetoothReaderListener {
    ...
    companion object {
        const val TAG = "com.kpfu.stripepay.fragment.event.EventFragment"

        private const val AMOUNT = "com.kpfu.stripepay.fragment.event.EventFragment.amount"
        private const val CURRENCY = "com.kpfu.stripepay.fragment.event.EventFragment.currency"
        private const val REQUEST_PAYMENT = "com.kpfu.stripepay.fragment.event.EventFragment.request_payment"
        private const val READ_REUSABLE_CARD = "com.kpfu.stripepay.fragment.event.EventFragment.read_reusable_card"
