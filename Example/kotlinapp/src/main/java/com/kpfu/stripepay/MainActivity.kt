...
import com.kpfu.stripepay.fragment.ConnectedReaderFragment
import com.kpfu.stripepay.fragment.PaymentFragment
import com.kpfu.stripepay.fragment.TerminalFragment
import com.kpfu.stripepay.fragment.UpdateReaderFragment
import com.kpfu.stripepay.fragment.discovery.DiscoveryFragment
import com.kpfu.stripepay.fragment.event.EventFragment
import com.kpfu.stripepay.fragment.location.LocationCreateFragment
import com.kpfu.stripepay.fragment.location.LocationSelectionController
import com.kpfu.stripepay.fragment.location.LocationSelectionFragment
import com.kpfu.stripepay.network.ApiClient
import com.kpfu.stripepay.network.TokenProvider
...
class MainActivity :
    AppCompatActivity(),
    com.kpfu.stripepay.NavigationListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.kpfu.stripepay.R.layout.activity_main)
    ...
    private fun initialize() {
        ...
        try {
            Terminal.initTerminal(
                ...
                com.kpfu.stripepay.TerminalEventListener()
            )
    ...
    private fun navigateTo(
        ...
        supportFragmentManager
            ...
            .apply {
                if (replace) {
                    replace(com.kpfu.stripepay.R.id.container, frag, tag)
                } else {
                    add(com.kpfu.stripepay.R.id.container, frag, tag)
                }
    ...
    private fun verifyGpsEnabled(): Boolean {
        ...
        if (!gpsEnabled) {
            // notify user
            AlertDialog.Builder(ContextThemeWrapper(this,
                com.kpfu.stripepay.R.style.Theme_MaterialComponents_DayNight_DarkActionBar
            ))
