...
import com.kpfu.stripepay.databinding.FragmentDiscoveryBinding
...
class DiscoveryFragment :
    ...
    companion object {
        ...
        const val TAG = "com.kpfu.stripepay.fragment.discovery.DiscoveryFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.readerClickListener = ReaderClickListener(
            activity as com.kpfu.stripepay.MainActivity,
            viewModel
        )
        ...
        viewBinding.cancelButton.setOnClickListener {
            val activityRef = WeakReference(activity as com.kpfu.stripepay.MainActivity)
