...
import com.kpfu.stripepay.databinding.FragmentUpdateReaderBinding
import com.kpfu.stripepay.viewmodel.UpdateReaderViewModel
...
class UpdateReaderFragment : Fragment(), BluetoothReaderListener {
    ...
    companion object {
        const val TAG = "com.kpfu.stripepay.fragment.UpdateReaderFragment"
    }

    private lateinit var binding: FragmentUpdateReaderBinding
    private lateinit var viewModel: UpdateReaderViewModel
    private lateinit var activityRef: WeakReference<com.kpfu.stripepay.MainActivity>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activityRef = WeakReference(activity as com.kpfu.stripepay.MainActivity)
    ...
    private fun exitWorkflow(activityRef: WeakReference<com.kpfu.stripepay.MainActivity>) {
